 ...
 */
export type FlightPageDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<
...
export type FlightsLandingDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithoutUID<Simplify<FlightsLandingDocumentData>, 'flights_landing', Lang>;
...
export type AllDocumentTypes = FlightPageDocument | FlightsLandingDocument | HomepageDocument;
...
export interface HeroWithMetricsCardsSliceDefaultPrimary {
   ...
   */
  metrics: prismic.GroupField<Simplify<HeroWithMetricsCardsSliceDefaultPrimaryMetricsItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionHeaderSlice = prismic.SharedSlice<'section_header', SectionHeaderSliceVariation>;
