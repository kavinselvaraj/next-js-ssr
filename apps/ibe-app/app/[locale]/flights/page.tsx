...
import { FlightResults } from '../../../features/flight-search/components';
import { createLocaleMetadata } from '../../../lib/i18n/metadata';

export const dynamic = 'force-dynamic';

export function generateMetadata({ params }: { params: { locale: string } }): Metadata {
  return createLocaleMetadata(params.locale, '/flights', {
...
export default function LocalizedFlightsPage() {
  return (
    <section className="space-y-8">
      <div className="rounded-3xl bg-gradient-to-r from-sky-950 via-sky-800 to-cyan-700 p-8 text-white shadow-lg">
        ...
        <h1 className="mt-3 text-4xl font-bold tracking-tight">
          Live fares for travellers who do not enjoy surprises.
        </h1>
